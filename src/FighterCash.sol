...
contract FighterCash is Ownable {
    ...
    function withdrawReward() external {
        ...
        uint256 userShare = (userBet * 9e18) / totalWinnerBets;

        uint256 pool = ((totalBetAmount[1] + totalBetAmount[2]) * 9) / 10;
        uint256 reward = (pool * userShare) / 1e18;
